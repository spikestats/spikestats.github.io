...
Spike Stats only uses the official Valorant API and does not collect or display any other data from unofficial sources. Therefore; Spike Stats is completely safe to use.
