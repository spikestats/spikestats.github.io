...
<body>
    ...
    <ul>
        ...
        <li><b>User ID</b> can be found be tapping and holding on the <b>"Delete"</b> button on the <b>Settings</b> page of Spike Stats. When you see the <b>"User Id copied."</b> message, return to this page and paste the value in the <b>User ID</b> field.</li>
