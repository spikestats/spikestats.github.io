...
[![Valorant Tracker KAST performance graph from Spike Stats match history page](/screenshots/valorant-tracker-graph-kast.png){:height=45%" width="45%"}](/screenshots/valorant-tracker-graph-kast.png)
[![Spike Stats app showing Valorant K/D trend graph over time](/screenshots/valorant-tracker-graph-kd.png){:height=45%" width="45%"}](/screenshots/valorant-tracker-graph-kd.png)
